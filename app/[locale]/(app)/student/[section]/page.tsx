...
const sections=["dashboard","onboarding","project-ideas","projects","planner","evidence","reflections","skills","feedback","portfolio","presentation","recommendation-evidence","subscription"]
