...
('50000000-0000-0000-0000-000000000006','Community Oral History Archive','Toplumsal Sözlü Tarih Arşivi','Interview local elders to document their experiences and preserve community history.','Yerel yaşlılarla röportaj yaparak deneyimlerini belgele ve toplum tarihini koru.',array['History','Anthropology'],8,4,200,'{"deliverable":"Digital audio archive and transcriptions"}','{"privacy":"Ensure full consent from all interviewees."}'),
('50000000-0000-0000-0000-000000000007','Accessible Campus Map Prototype','Erişilebilir Kampüs Haritası Prototipi','Design and code an accessibility-focused map of your school or local community center.','Okulunuzun veya yerel toplum merkezinizin erişilebilirlik odaklı bir haritasını tasarla ve kodla.',array['Computer Science','Urban Planning'],6,5,300,'{"deliverable":"Interactive map prototype and user feedback report"}','{"claims":"Do not invent accessibility regulations or official endorsements."}'),
('50000000-0000-0000-0000-000000000008','Local Business Energy Audit','Yerel İşletme Enerji Denetimi','Partner with a small business to analyze energy usage and propose cost-effective optimizations.','Enerji kullanımını analiz etmek ve uygun maliyetli optimizasyonlar önermek için küçük bir işletmeyle ortak çalış.',array['Environmental Science','Economics'],6,4,150,'{"deliverable":"Energy audit report and proposed action plan"}','{"privacy":"Keep business financial data confidential."}'),
('50000000-0000-0000-0000-000000000009','Youth Literacy Tutoring Program','Gençlik Okuryazarlığı Özel Ders Programı','Design a structured tutoring curriculum and document progress for 2-3 younger students over time.','Yapılandırılmış bir özel ders müfredatı tasarla ve zaman içinde 2-3 genç öğrencinin ilerlemesini belgele.',array['Education','Sociology'],10,3,100,'{"deliverable":"Curriculum guide and anonymized student progress logs"}','{"privacy":"Anonymize student data and do not guarantee grade improvements."}'),
('50000000-0000-0000-0000-00000000000a','Air Quality Sensor Network Deployment','Hava Kalitesi Sensör Ağı Kurulumu','Build and deploy low-cost air quality sensors in your neighborhood and analyze the data.','Mahallenizde düşük maliyetli hava kalitesi sensörleri kur ve verileri analiz et.',array['Engineering','Environmental Science'],8,5,800,'{"deliverable":"Deployed sensor network and data analysis dashboard"}','{"claims":"Report local data accurately without extrapolating to the whole city."}'),
('50000000-0000-0000-0000-00000000000b','School Debate Tournament Organization','Okul Münazara Turnuvası Organizasyonu','Organize an inter-class debate tournament, managing logistics, judging criteria, and participant feedback.','Lojistik, jüri kriterleri ve katılımcı geri bildirimlerini yöneterek sınıflar arası bir münazara turnuvası düzenle.',array['Political Science','Communications'],6,4,200,'{"deliverable":"Tournament schedule, judging rubrics, and feedback summary"}','{"claims":"Do not invent attendance numbers or sponsorships."}'),
('50000000-0000-0000-0000-00000000000c','Algorithmic Bias Research Paper','Algoritmik Önyargı Araştırma Makalesi','Conduct a literature review and run simple tests on open-source AI models to document bias.','Açık kaynaklı yapay zeka modelleri üzerinde literatür taraması yap ve önyargıyı belgelemek için basit testler yürüt.',array['Computer Science','Philosophy'],8,5,0,'{"deliverable":"Research paper and test methodology appendix"}','{"claims":"Do not present simple tests as novel academic breakthroughs."}'),
('50000000-0000-0000-0000-00000000000d','Community Garden Yield Analysis','Topluluk Bahçesi Verim Analizi','Implement a data tracking system for a local community garden to optimize planting schedules and yield.','Ekim programlarını ve verimi optimize etmek için yerel bir topluluk bahçesinde veri izleme sistemi uygula.',array['Biology','Statistics'],10,3,250,'{"deliverable":"Data tracking system and season yield report"}','{"claims":"Report factual yield data without claiming to solve local food insecurity."}'),
('50000000-0000-0000-0000-00000000000e','Student Mental Health Resources App','Öğrenci Ruh Sağlığı Kaynakları Uygulaması','Develop a prototype app aggregating verified mental health resources and hotlines for students.','Öğrenciler için doğrulanmış ruh sağlığı kaynaklarını ve yardım hatlarını toplayan bir prototip uygulama geliştir.',array['Psychology','Computer Science'],8,6,300,'{"deliverable":"Interactive app prototype and resource verification log"}','{"claims":"Do not provide medical advice or claim clinical efficacy."}'),
('50000000-0000-0000-0000-00000000000f','Local Election Voter Guide Compilation','Yerel Seçim Seçmen Rehberi Derlemesi','Compile a non-partisan, accessible guide of local election candidates and their platforms.','Yerel seçim adayları ve platformlarının tarafsız, erişilebilir bir rehberini derle.',array['Political Science','Public Policy'],4,6,100,'{"deliverable":"Non-partisan voter guide website or booklet"}','{"claims":"Maintain strict neutrality and do not invent candidate statements."}');
